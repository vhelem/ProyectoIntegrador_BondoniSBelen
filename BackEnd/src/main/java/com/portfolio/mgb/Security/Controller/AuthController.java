...
import com.portfolio.mgb.Security.Services.RolService;
import com.portfolio.mgb.Security.Services.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        if(usuarioService.existsByEmail(nuevoUsuario.getEmail()))
            return new ResponseEntity(new Mensaje("Esa casilla de correo ya existe"),HttpStatus.BAD_REQUEST);
